...
(big-O notation) โดย{\wbr}เรา{\wbr}จะ{\wbr}กล่าว เช่น $n^2 + 100n$ เป็น $O(n^2)$ หรือ $30n +
5$ เป็น $O(n)$ เรา{\wbr}จะ{\wbr}หา{\wbr}คำ{\wbr}นิยาม{\wbr}ที่{\wbr}สะท้อน{\wbr}สิ่ง{\wbr}ที่{\wbr}เรา{\wbr}ได้{\wbr}ทดลอง{\wbr}มา ใน{\wbr}การ{\wbr}ที่{\wbr}จะ{\wbr}ระบุ{\wbr}ว่า{\wbr}ฟังก์ชัน{\wbr}
$f(n)$ เป็น $O(g(n))$ (หรือ{\wbr}มี{\wbr}อัตรา{\wbr}การ{\wbr}โต{\wbr}ไม่{\wbr}เกิน{\wbr}ฟังก์ชัน $g(n)$)
\begin{itemize}
\item ข้อสังเกต{\wbr}ข้อ{\wbr}แรก{\wbr}ก็{\wbr}คือ ค่าคงที่{\wbr}ไม่{\wbr}มี{\wbr}ผล นั่น{\wbr}คือ{\wbr}ฟังก์ชัน $100n$ หรือ $1000n$ หรือ{\wbr}กระทั่ง{\wbr}
  ...
  เรา{\wbr}ต้อง{\wbr}ยอม{\wbr}ให้{\wbr}มี{\wbr}การ{\wbr}ใช้{\wbr}ค่าคงที่{\wbr}มา ``ช่วย'' ฟังก์ชัน $g(n)$ ให้{\wbr}มี{\wbr}ค่า{\wbr}มาก{\wbr}ขึ้น{\wbr}ได้{\wbr}
...
จาก{\wbr}ข้อสังเกต{\wbr}ทั้ง{\wbr}สอง เรา{\wbr}จะ{\wbr}สมมติ{\wbr}ค่าคงที่{\wbr}สอง{\wbr}จำนวน{\wbr}คือ $c$ เป็น{\wbr}ค่าคงที่{\wbr}ที่{\wbr}เรา{\wbr}ยอม{\wbr}

เรา{\wbr}จะ{\wbr}นิยาม{\wbr}อย่าง{\wbr}เป็นทางการ{\wbr}ดังนี้:

เรา{\wbr}จะ{\wbr}กล่าว{\wbr}ว่า{\wbr}ฟังก์ชัน $f(n)$ เป็น $O(g(n))$ (หรือ{\wbr}มี{\wbr}การ{\wbr}โต{\wbr}เป็น $O(g(n))$) ก็{\wbr}ต่อเมื่อ{\wbr}
มี{\wbr}ค่าคงที่ $c$ และ $n_0$ ที่ $f(n) \leq c\cdot g(n)$ เมื่อ $n\geq n_0$
